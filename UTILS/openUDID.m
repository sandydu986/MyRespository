...
// Theoretically, this function is called once ever per application when calling [OpenUDID openValue] for the first time.
// After that, the caching/pasteboard/redundancy mechanism inside [OpenUDID openValue] returns a persistent and cross application OpenUDID
//
+ (NSString*) _generateFreshOpenUDID {
