...
- (void)startRequest
{
    ...
    //
//解决slove kCFStreamSSLAllowsExpiredCertificates  deprecated的问题警告⚠️
...
+ (NSDate *)expiryDateForRequest:(ASIHTTPRequest *)request maxAge:(NSTimeInterval)maxAge
{
	...
	if (maxAge) {
		return [[NSDate date] dateByAddingTimeInterval:maxAge];/*ios7为警告修改掉_return [[NSDate date] addTimeInterval:maxAge]*/
	} else {
